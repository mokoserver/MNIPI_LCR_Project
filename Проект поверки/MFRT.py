...
def ConvertFloatToString(value: (float, str, int), reference_number: str = None, resolution: int = 0,
                         ...
                         type_value_result: str = "String", enable_rounding: bool = False, abs_number: bool = False):
    """
        ...
        :param abs_number: bool variable: enable abs number mode. Defaults to False
    ...
    library_object = MFRTLibrary(
        ...
        type_value_result=type_value_result, abs_number=abs_number)
